...
10년차 풀스택 개발자로, 임베디드 시스템 연구에서 시작해 이커머스 플랫폼 개발, 
호주 현지 IT 프리랜서까지
— 개발의 전 영역을 직접 경험해 왔습니다.

현재는 **Next.js/React** 기반 웹 서비스 개발과 **AI 기반 서비스 기획·프로토타이핑**에 집중하고 있습니다.
...
| **2013** | The World Embedded Software Contest | 대회 | 제 11회 임베디드 소프트웨어 경진대회 본선진출 — Team DEUposible · BabyCPR |
...
| **2012.07 ~ 2012.08** | 동의대학교 앱창작터 | 교육이수 | 개발자 아이폰 과정 |
...
|------|-------|-------------|
| 2014 | KAIST 웨어러블 컴퓨터 경진대회 — 장려상 | KAIST |
...
|------|--------------|--------|
| 2012 | PC Master (정비사) | 한국정보평가협회 |
| 2007 | 워드프로세서 1급 | 대한상공회의소 |
